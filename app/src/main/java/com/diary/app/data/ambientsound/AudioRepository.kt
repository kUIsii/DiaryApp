...
object AudioRepository {
    ...
    private val allTracks = listOf(
        // Sleep
        AudioTrack("s1", "sleep", "雨打芭蕉", 30, hq(720153, 1504845),
            "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=400&q=80"),
        AudioTrack("s2", "sleep", "壁炉篝火", 30, hq(508844, 1934171),
            "https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?w=400&q=80"),
        AudioTrack("s3", "sleep", "海浪白噪音", 30, hq(578524, 5487341),
            "https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=400&q=80"),
        AudioTrack("s4", "sleep", "深层宁静", 30, hq(810260, 5287430),
            "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=400&q=80"),
        AudioTrack("s5", "sleep", "细雨微风", 30, hq(607228, 11069322),
            "https://images.unsplash.com/photo-1438449805896-28a666819a20?w=400&q=80"),
        AudioTrack("s6", "sleep", "炉边夜读", 30, hq(508844, 1934171),
            "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&q=80"),
        // Nature
        AudioTrack("n1", "nature", "山间溪流", 30, hq(401127, 7724516),
