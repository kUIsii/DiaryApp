...
// Light mode - Morning Glow
val LightBackgroundStart = Color(0xFFF0F2FA)
val LightBackgroundMid = Color(0xFFE8ECFF)
val LightBackgroundEnd = Color(0xFFF5F0FF)
...
// Dark mode - Deep Galaxy
val DarkBackgroundStart = Color(0xFF0D0D0D)
val DarkBackgroundEnd = Color(0xFF1A1A3E)
...
val MoodHappy = Color(0xFF667EEA) to Color(0xFF764BA2)
val MoodCalm = Color(0xFF43E97B) to Color(0xFF38F9D7)
